...
def create_regions(world: MultiWorld, player: int, seed_locations):
    ...
    connect_regions(world, player, "Beverly Hills Shops", "Beverly Hills Shops $10")
    connect_regions(world, player, "Beverly Hills Shops", "Beverly Hills Shops $20")
    connect_regions(world, player, "Beverly Hills Shops", "Beverly Hills Shops $30")
    connect_regions(world, player, "Beverly Hills Shops", "Beverly Hills Shops $50")
    connect_regions(world, player, "Beverly Hills Shops", "Beverly Hills Shops $100")
    connect_regions(world, player, "Beverly Hills Shops", "Beverly Hills Shops $1250")
